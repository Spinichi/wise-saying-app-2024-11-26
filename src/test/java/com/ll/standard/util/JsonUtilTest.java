...
public class JsonUtilTest {
    ...
    // WiseSaying 객체 => Map => json
    @Test
    @DisplayName("Map을 JSON으로 변환할 수 있다. (필드 1개)")
    public void t1() {
        // given
    ...
    @Test
    @DisplayName("Map을 JSON으로 변환할 수 있다. (필드 2개)")
    public void t2() {
        // given
    ...
    @Test
    @DisplayName("Map을 JSON으로 변환할 수 있다. (숫자(정수) 필드)")
    public void t3() {
        // given
        Map<String, Object> map = new LinkedHashMap<>();
        map.put("id", 1);
    ...
    @Test
    @DisplayName("Map을 JSON으로 변환할 수 있다. (숫자(실수) 필드)")
    public void t4() {
        // given
        Map<String, Object> map = new LinkedHashMap<>();
        map.put("id", 1);
    ...
    @Test
    @DisplayName("Map을 JSON으로 변환할 수 있다. (논리 필드)")
    public void t5() {
        // given
        Map<String, Object> map = new LinkedHashMap<>();
        map.put("id", 1);
